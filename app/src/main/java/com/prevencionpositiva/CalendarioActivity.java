    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lista.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CalendarioActivity.this,IncidenciaActivity.class);
        ...
        riesgo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CalendarioActivity.this,Webview.class);
                startActivity(intent);
            }
        });
        ...
        clima.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CalendarioActivity.this,AgricolaActivity.class);
                startActivity(intent);
            }
        });
    }
